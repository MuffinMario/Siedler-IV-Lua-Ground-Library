-- Vergewisser dich, dass vor diesem Code noch die Library in das Script gehört!
...
function new_game()
  ...
  Grounds.SetGround(100,100,3,Grounds.GRASS_DESERT) -- GRASS-WÜSTE
  Grounds.SetGround(100,100,3,Grounds.DESERT_GRASS) -- WÜSTE-GRASS
